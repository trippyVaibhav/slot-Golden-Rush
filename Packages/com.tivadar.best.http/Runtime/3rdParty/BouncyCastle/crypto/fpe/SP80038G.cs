...
namespace Best.HTTP.SecureProtocol.Org.BouncyCastle.Crypto.Fpe
{
    ...
    {
        internal static readonly string FPE_DISABLED = "Best.HTTP.SecureProtocol.Org.BouncyCastle.Fpe.Disable";
        internal static readonly string FF1_DISABLED = "Best.HTTP.SecureProtocol.Org.BouncyCastle.Fpe.Disable_Ff1";
