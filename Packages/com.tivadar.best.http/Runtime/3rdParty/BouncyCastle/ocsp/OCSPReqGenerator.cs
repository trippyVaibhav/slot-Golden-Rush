...
namespace Best.HTTP.SecureProtocol.Org.BouncyCastle.Ocsp
{
	public class OcspReqGenerator
	{
		...
		private class RequestObject
		{
			...
			public Best.HTTP.SecureProtocol.Org.BouncyCastle.Asn1.Ocsp.Request ToRequest()
			{
				return new Best.HTTP.SecureProtocol.Org.BouncyCastle.Asn1.Ocsp.Request(certId.ToAsn1Object(), extensions);
			}
		}
