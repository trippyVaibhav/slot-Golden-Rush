...
using Best.HTTP.SecureProtocol.Org.BouncyCastle.Asn1.Utilities;
...
namespace Best.HTTP.SecureProtocol.Org.BouncyCastle.X509
{
    ...
    //		, PKCS12BagAttributeCarrier
    {
        ...
        /// <summary>
        /// Return a <see cref="Best.HTTP.SecureProtocol.Org.BouncyCastle.Math.BigInteger">BigInteger</see> containing the serial number.
        /// </summary>
