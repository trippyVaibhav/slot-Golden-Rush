...
using Best.HTTP.SecureProtocol.Org.BouncyCastle.Asn1.X500.Style;
...
namespace Best.HTTP.SecureProtocol.Org.BouncyCastle.Pkix
{
    public class PkixNameConstraintValidator
    {
        ...
        {
            if (Best.HTTP.SecureProtocol.Org.BouncyCastle.Utilities.Arrays.AreEqual(ip1, ip2))
            {
                return 0;
            }
            if (Best.HTTP.SecureProtocol.Org.BouncyCastle.Utilities.Arrays.AreEqual(Max(ip1, ip2), ip1))
            {
                return 1;
            }
            return -1;
