...
namespace Best.SocketIO.Transports
{
    ...
    public sealed class PollingTransport : ITransport
    {
        ...
        public void Open()
        {
            ...
            request.Context.Add("SocketManager", this.Manager.Context);
        ...
        public void Send(System.Collections.Generic.List<OutgoingPacket> packets)
        {
            ...
            LastRequest.Context.Add("SocketManager", this.Manager.Context);
        ...
        public void Poll()
        {
            ...
            PollRequest.Context.Add("SocketManager", this.Manager.Context);
                ...
                while (idx < resp.Data.Length)
                {
                    ...
                    else
                    {
                        ...
                        if (this.State == TransportStates.Opening)
                        {
                            ...
                            {
                                var handshake = Best.HTTP.JSON.LitJson.JsonMapper.ToObject<HandshakeData>(Encoding.UTF8.GetString(resp.Data, idx + 1, length - 1));
