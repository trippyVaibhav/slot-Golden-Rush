...
namespace Duck.Http.Service
{
	public interface IHttpService
	{
		...
		IEnumerator Send(IHttpRequest request, Action<HttpResponse> onSuccess = null, Action<HttpResponse> onError = null, Action<HttpResponse> onNetworkError = null,string requestMethod="");
